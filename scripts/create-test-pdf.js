...
// Create a simple PDF-like content (this is just a text file for now)
...
/F1 12 Tf
100 700 Td
(This is a test PDF file for pdf-parse library) Tj
ET
endstream
endobj
...
console.log('Created test PDF file at:', pdfPath);
